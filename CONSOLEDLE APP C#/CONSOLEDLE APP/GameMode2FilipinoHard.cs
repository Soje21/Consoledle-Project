...
{
    public class GameMode2FilHard
    {
        //GAMEMODE 2 (HARD) METHOD
        public static void GameMode2FilipinoHard()
        {
        ...
        Again:
            ...
            Function.CenterText("Player 1, I-type ang iyong napiling salita na pahuhulaan. Pitong(7) letra lamang na salita!");
            ...
            Function.CenterText("Player 2, Hulaan ang salita! Pitong(7) letra lamang!");
