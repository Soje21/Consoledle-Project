...
{
    public class GameMode2EngMediocre
    {
        //GAMEMODE 2 (MEDIOCRE) METHOD
        public static void GameMode2EnglishMediocre()
        {
            ...
            Function.CenterText("Player 1, Please enter your guess word (must consist of  six(6) leters only!)");
            ...
            //GAME TITLE
            Text.GameTitle();
            Function.CenterText("Player 2's Turn, Guess the word! Six(6) letters only!");
