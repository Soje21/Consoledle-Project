...
{
    public class GameMode2EngEasy
    {
        //GAMEMODE 2 (EASY) METHOD
        public static void GameMode2EnglishEasy()
        {
            ...
            Function.CenterText("Player 1, Please enter your guess word (must consist of five(5) leters only!)");
            ...
            Function.CenterText("Player 2's Turn, Guess the word! Five(5) letters only!");
